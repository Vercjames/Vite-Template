  ...
  return {
    ...
    resolve: {
      alias: {
        ...
        "@MSTRoot": path.resolve(__dirname, "./client-schemas/mobx-tree/MobxRoot.tsx"),
        "@MSTContext": path.resolve(__dirname, "./client-schemas/mobx-tree/MobxContext.tsx"),
        "@MSTInterfaces": path.resolve(__dirname, "./client-schemas/mobx-tree/MobxInterfaces.tsx"),
